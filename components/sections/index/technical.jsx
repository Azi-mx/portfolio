        ...
        <section className={`${about.content} ${about.container}`}>
          <div className={about.copy}>
            ...
            <BadgesBlock
              ...
              copy="These are the tools that make my daily work exciting and efficient! From collaborating with teams on Slack to designing creative projects in Figma and staying organized with Jira, each one plays a unique role. Whether it's brainstorming on Miro or coding in VSCode, they help me bring ideas to life with ease and fun! This is just some of the software I have used over that time."
              list={software}
              block="software"
...
const software = [
  ...
  { key: "project-diagram", name: "Miro", type: "fas" },
